...
hdu2 = fits.open('tex_on_c18o_header.fits')[0]
hdu3 = fits.open('dustcoldens_on_c18o_header.fits')[0]
hdu4 = fits.open('mom0_imsub_mask_imfit_c18o_pix_2_Tmb.fits')[0]

mom018data = hdu1.data
mom0sens = 0.7 # K
sensbool = np.copy(mom018data)
sensbool[mom018data < 3.*mom0sens] = 0
...
hdu4.writeto('abun18.fits', output_verify='exception', overwrite=True, checksum=False)

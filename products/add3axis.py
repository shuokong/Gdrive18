...
mom018hdulist = pyfits.open('mom0_stick_mask_imfit_c18o_pix_2_Tmb.fits')
templatehdulist = pyfits.open('gasT_on_stick_header.fits')
templatedata = templatehdulist[0].data[np.newaxis,:,:]
templatehdulist[0].header['NAXIS'] = 3
pyfits.writeto('threeaxes_gasT_on_stick_header.fits',templatedata,templatehdulist[0].header,output_verify='exception',clobber=True,checksum=False)

mom018hdulist = pyfits.open('mom0_stick_mask_imfit_c18o_pix_2_Tmb.fits')
templatehdulist = pyfits.open('dustT_on_stick_header.fits')
templatedata = templatehdulist[0].data[np.newaxis,:,:]
templatehdulist[0].header['NAXIS'] = 3
pyfits.writeto('threeaxes_dustT_on_stick_header.fits',templatedata,templatehdulist[0].header,output_verify='exception',clobber=True,checksum=False)
